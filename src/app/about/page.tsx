        ...
        <div className="space-y-12">
          ...
          <section>
            <p className="text-lg leading-relaxed text-stone-700 mb-6">
              ...
              Norwegian technology company. Watchdog analyzes invoices and
              compares them with purchase agreements, supplier contracts, and
              price lists. The software helps organizations check whether they
              are billed according to agreed terms.
            </p>
            <p className="text-lg leading-relaxed text-stone-700 mb-6">
              Watchdog currently analyzes around 10 billion NOK in annual
              purchases. The software is designed to handle large purchase
            ...
            <p className="text-lg leading-relaxed text-stone-700  ">
              The system connects to commonly used accounting and ERP platforms
              such as Microsoft Business Central, MS Dynamics, 24SevenOffice,
              Tripletex, PowerOffice, Visma Business NXT. In a typical setup,
              companies can connect their data and begin analysis in minutes.
              Watchdog reviews invoices automatically and highlights potential
              discrepancies, such as incorrect pricing, duplicates, or missing
              contractual discounts. Results are presented as alerts or reports
              that finance, procurement, or accounting teams can investigate.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-lg leading-relaxed text-stone-700">
              ...
              is Watchdog. The company is backed by serial founders and{' '}
              <a
              ...
              The supersolve headquarters is located in Parkveien 12 in Oslo,
              Norway.
            </p>
          </section>
