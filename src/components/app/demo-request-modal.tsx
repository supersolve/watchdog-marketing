...
export function DemoRequestModal({
  ...
  const form = useForm<DemoRequestData>({
    ...
    onSubmit: async (values) => {
      if (!privacyConsent) {
        throw new Error('Please agree to our terms to proceed')
      }
          ...
          {form.isSubmitted ? (
            ...
            <>
              ...
              <form onSubmit={form.handleSubmit} className="space-y-4">
                ...
                <div
                  className="flex items-start space-x-2 brave-show"
                  id="terms-agreement"
                >
                  <input
                    type="checkbox"
                    ...
                    className="mt-0.5 h-4 w-4 border-stone-300 rounded focus:ring-accent brave-checkbox"
                    style={{ display: 'block', visibility: 'visible' }}
                  />
                  <label
                    htmlFor="termsAgreement"
                    className="text-sm text-stone-600 leading-relaxed cursor-pointer brave-label"
                    style={{ display: 'block', visibility: 'visible' }}
                  >
                    I agree to allow my contact information to be used for demo
                    scheduling purposes as outlined in our{' '}
                    <a
                      href="/legal/privacy"
